Infrared (IR) Sensor with Motor Control

This Arduino code uses an infrared (IR) sensor to detect objects. If an object is detected within a threshold distance, it rotates a motor connected to a motor driver module in one direction.
